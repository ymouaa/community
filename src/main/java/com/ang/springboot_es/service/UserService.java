...
//    private LoginTicketMapper loginTicketMapper;
    ...
    public Map<String, Object> login(String username, String password, int expiredSeconds) {
        ...
        // redisTemplate.opsForValue().set(redisKey, loginTicket, expiredSeconds,
        // TimeUnit.SECONDS);
    ...
    // 查用户_权限中间表 来获取权限
//	public Collection<? extends GrantedAuthority> getAuthority(int userId) {
//		List<Authority> authorityList = authorityMapper.selectAuthoritysByUserId(userId);
//		List<SimpleGrantedAuthority> list =new ArrayList<>();
//		if(authorityList!=null&&authorityList.size()>0) {
//    		for (Authority a : authorityList) {
//				list.add(new SimpleGrantedAuthority(a.getAuthority())); //user,admin,moderator
//			}
//    	}else {
